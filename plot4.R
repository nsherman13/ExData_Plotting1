...
par(mfrow = c(2,2))
plot(x = clean_data$DateTime, y = clean_data$Global_active_power,type = "l",xlab = "",ylab = "Global Active Power")
plot(x = clean_data$DateTime, y = clean_data$Voltage,type = "l",xlab = "datetime",ylab = "Voltage")
